...
let collectGatewayCharges = "Y"; // Define whether to collect gateway charges ('Y' or 'N')
let gatewayChargePercentage = 1.0218; // Razorpay charges ~2.18%
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (collectGatewayCharges === "Y") {
      ...
      priceNoteElement.innerHTML = '(I agree to <a href="/policies" target="_blank" rel="noopener noreferrer">T&C</a>)';
    }
  });
