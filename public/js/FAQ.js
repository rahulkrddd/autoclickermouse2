const faqQuestions = [
    ...
    { category: "General", question: "Who can benefit from using this Auto Clicker Mouse?", answer: "IT engineers, remote workers, and anyone needing to keep their system active without manual intervention can benefit from this device." },
    { category: "General", question: "Can this bypass time tracker software?", answer: "Yes, it is designed to bypass time tracker software like WAM, Prohance, and other similar monitoring tools." },
